...
import './GearsLoader.scss';

/* 
  Dynamic properties:
    width: sets the width of the svg
    fill: sets the fill for both gears
    animationDuration: sets the duration of the animation for both gears. defaults to 4s
*/
